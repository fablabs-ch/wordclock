...
This page describes the different layouts and their specificity.
...
The proposed layouts have been designed to distribute the holes across the whole
layout. The holes in the table can be:
